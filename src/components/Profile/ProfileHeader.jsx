...
const ProfileHeader = () => {
  ...
  const {handleFollowAndUnfollowUser,isFollowing,isUpdating} = useFollowAndUnfollowUser(userProfile?.uid)
      ...
      <VStack alignItems={"start"} gap={2} mx={"auto"} flex={1}>
        <Flex gap={4} direction={{base:"column", sm:"row"}} justifyContent={{base:"center", sm:"flex-start"}} alignItems={"center"} w={"full"}>
            ...
            {visitingOwnProfileAndAuth && (
              <Flex gap={4} alignItems={"center"} justifyContent={"center"} onClick={onOpen}>
            ...
            {visitingAnotherProfileAndAuth && (
              <Flex gap={4} alignItems={"center"} justifyContent={"center"}>
                  ...
                  onClick={handleFollowAndUnfollowUser} isLoading={isUpdating}>
